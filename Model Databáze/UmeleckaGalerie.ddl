...
CREATE TABLE druhy_platb (
    iddruhplatby INTEGER NOT NULL,
    nazev        VARCHAR2(250) NOT NULL
);

ALTER TABLE druhy_platb ADD CONSTRAINT druh_platby_pk PRIMARY KEY ( iddruhplatby );

ALTER TABLE druhy_platb ADD CONSTRAINT druhy_plateb_nazev_un UNIQUE ( nazev );
...
ALTER TABLE kupci ADD CONSTRAINT kupci_pk PRIMARY KEY ( idkupec );
...
ALTER TABLE podklady ADD CONSTRAINT podklady_nazev_un UNIQUE ( nazev );
...
ALTER TABLE posty ADD CONSTRAINT posty_psc_un UNIQUE ( psc );
...
ALTER TABLE prilohy ADD CONSTRAINT prilohy_pk PRIMARY KEY ( idpriloha );
...
ALTER TABLE role ADD CONSTRAINT role_nazev_unv1 UNIQUE ( nazev );
...
ALTER TABLE techniky ADD CONSTRAINT techniky_nazev_un UNIQUE ( nazev );
...
ALTER TABLE umelecka_dila ADD CONSTRAINT umelecka_dila_pk PRIMARY KEY ( idumeleckedilo );
...
ALTER TABLE adresy
    ADD CONSTRAINT adresy_posty_fk FOREIGN KEY ( idposta )
        REFERENCES posty ( idposta );

ALTER TABLE kupci
    ADD CONSTRAINT kupci_adresy_fk FOREIGN KEY ( idadresa )
        REFERENCES adresy ( idadresa );

ALTER TABLE navstevy
    ADD CONSTRAINT navstevy_druhy_navstev_fk FOREIGN KEY ( iddruhnavstevy )
        REFERENCES druhy_navstev ( iddruhnavstevy );

ALTER TABLE navstevy
    ADD CONSTRAINT navstevy_vystavy_fk FOREIGN KEY ( idvystava )
...
ALTER TABLE obrazy
    ADD CONSTRAINT obrazy_podklady_fk FOREIGN KEY ( idpodklad )
        REFERENCES podklady ( idpodklad );

ALTER TABLE obrazy
    ADD CONSTRAINT obrazy_techniky_fk FOREIGN KEY ( idtechnika )
        REFERENCES techniky ( idtechnika );

ALTER TABLE prilohy
    ADD CONSTRAINT prilohy_umelecka_dila_fk FOREIGN KEY ( idumeleckedilo )
        REFERENCES umelecka_dila ( idumeleckedilo );

ALTER TABLE prodeje
    ADD CONSTRAINT prodej_kupec_fk FOREIGN KEY ( idkupec )
        REFERENCES kupci ( idkupec );

ALTER TABLE prodeje
    ADD CONSTRAINT prodeje_druhy_plateb_fk FOREIGN KEY ( iddruhplatby )
        REFERENCES druhy_platb ( iddruhplatby );
...
ALTER TABLE sochy
    ADD CONSTRAINT sochy_materialy_fk FOREIGN KEY ( idmaterial )
...
ALTER TABLE umelci
    ADD CONSTRAINT umelec_mentor_fk FOREIGN KEY ( idmentor )
        REFERENCES umelci ( idumelec );

ALTER TABLE umelecka_dila
    ADD CONSTRAINT umelecka_dila_prodeje_fk FOREIGN KEY ( idprodej )
        REFERENCES prodeje ( idprodej );

ALTER TABLE umelecka_dila
    ADD CONSTRAINT umelecka_dila_vystavy_fk FOREIGN KEY ( idvystava )
        REFERENCES vystavy ( idvystava );
...
ALTER TABLE vystavy
    ADD CONSTRAINT vystavy_vzdelavaci_programy_fk FOREIGN KEY ( idvzdelavaciprogram )
...
CREATE SEQUENCE druhy_platb_iddruhplatby_seq START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER druhy_platb_iddruhplatby_trg BEFORE
    INSERT ON druhy_platb
    FOR EACH ROW
    WHEN ( new.iddruhplatby IS NULL )
BEGIN
    :new.iddruhplatby := druhy_platb_iddruhplatby_seq.nextval;
END;
/
