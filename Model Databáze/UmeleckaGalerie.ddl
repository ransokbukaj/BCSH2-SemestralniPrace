...
ALTER TABLE druhy_plateb ADD CONSTRAINT druhy_platby_nazev_un UNIQUE ( nazev );

CREATE TABLE kupci (
    idkupec         NUMBER NOT NULL,
    jmeno           VARCHAR2(50) NOT NULL,
    prijmeni        VARCHAR2(50) NOT NULL,
    telefonicislo   VARCHAR2(16) NOT NULL,
    email           VARCHAR2(100),
    adresy_idadresa INTEGER NOT NULL,
    idkupec         INTEGER NOT NULL
);

ALTER TABLE kupci ADD CONSTRAINT kupec_pk PRIMARY KEY ( idkupec );

ALTER TABLE kupci ADD CONSTRAINT kupec_idkupec_un UNIQUE ( idkupec );
...
ALTER TABLE kupci
    ADD CONSTRAINT kupci_adresy_fk FOREIGN KEY ( adresy_idadresa )
        REFERENCES adresy ( idadresa );

ALTER TABLE navstevy
    ADD CONSTRAINT navstevy_druhy_navstevy_fk FOREIGN KEY ( iddruhnavstevy )
...
ALTER TABLE prodeje
    ADD CONSTRAINT prodeje_druhy_platby_fk FOREIGN KEY ( iddruhplatby )
        REFERENCES druhy_plateb ( iddruhplatby );

ALTER TABLE prodeje
    ADD CONSTRAINT prodeje_kupci_fk FOREIGN KEY ( idkupec )
